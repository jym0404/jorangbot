    ...
    if message.content.startswith('조랭봇'):
        if message.content == "조랭봇":
            ...
            try:
                ...
                try:
                    await message.channel.send(deunglok[message.content[:5]][0])
                    await message.channel.send(deunglok[message.content[:5]][1]+"님이 알려주셨어요!")
                except:
