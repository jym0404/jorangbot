...
async def on_message(message):
    if message.content.startswith('조랭봇 '):
        if message.content.startswith('조랭봇 계산 '):
            ...
            if checkope == len(calcstr):
                ...
                await message.channel.send("연산자와 숫자, 특정 함수만 입력할 수 있어요!")
    ...
    elif message.content.startswith('조랭보수 '):
        await message.channel.send("어... 오타가 그렇게 나면...")
    elif message.content == "조랭보수":
        await message.channel.send("어... 오타가 그렇게 나면...")
